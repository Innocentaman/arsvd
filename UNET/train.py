...
if __name__ == "__main__":
    ...
    callbacks = [
        ...
        ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=args.lr_patience, min_lr=1e-7, verbose=1),
        CSVLogger(csv_path),
        EarlyStopping(monitor='val_loss', patience=args.patience, restore_best_weights=False),
    ]
